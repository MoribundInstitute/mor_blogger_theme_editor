...
use mor_blogger_core::diagnostics::{DiagnosticResult, Severity};
...
#[component]
pub fn DiagnosticsDialog(mut props: DiagnosticsPanelProps) -> Element {
    ...
    rsx! {
        Modal {
            ...
            on_close: move |_| props.open.set(false),
