        ...
        div { class: "floating-editor-actions",
            ...
            if pos != DockPosition::mor_panel_right {
                button {
                    title: "Dock Right",
                    onclick: move |_| {
                        layout.request_exclusive_dock("css_builder", DockPosition::mor_panel_right);
                    },
                    IconDockRight {}
                }
            }
            if !is_floating {
                button {
                    title: "Float Window",
                    onclick: move |_| {
                        layout.request_exclusive_dock("css_builder", DockPosition::Floating);
                    },
                    IconFloat {}
                }
            }
    ...
    let inner_content = rsx! {
        if is_floating {
            ...
            div { class: "editor-panel-header",
                h2 { class: "editor-panel-title", "CSS Token Builder" }
                {header_actions}
            }
        }
        ...
        div {
            ...
            // Body content: split vertically inside sidebar
            div {
                style: "flex: 1; display: flex; flex-direction: column; gap: 12px; padding: 12px; overflow-y: auto;",
