...
fn insert_custom_icon(config: &mut ThemeConfig, key: &str, raw_svg: &str) -> bool {
    if !is_svg(raw_svg) {
        return false;
    }
    let encoded_uri = svg_to_data_uri(raw_svg);
    config.icons.custom_icons.insert(key.to_string(), encoded_uri);
    true
}
            ...
            div { class: "editor-field-group",
                div { style: "display: grid; grid-template-columns: repeat(5, 1fr); gap: 8px;",
                    div { class: "icon-preview-box", style: "aspect-ratio: 1; display: flex; align-items: center; justify-content: center; background: var(--bg-elevated); border: 1px solid var(--editor-border-soft); border-radius: 4px;", title: "Menu", 
                        span { style: "display: block; width: 20px; height: 20px; background-color: var(--editor-text); -webkit-mask-image: {current_config.icons.menu}; -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center;" } 
                    }
                    div { class: "icon-preview-box", style: "aspect-ratio: 1; display: flex; align-items: center; justify-content: center; background: var(--bg-elevated); border: 1px solid var(--editor-border-soft); border-radius: 4px;", title: "Search", 
                        span { style: "display: block; width: 20px; height: 20px; background-color: var(--editor-text); -webkit-mask-image: {current_config.icons.search}; -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center;" } 
                    }
                    div { class: "icon-preview-box", style: "aspect-ratio: 1; display: flex; align-items: center; justify-content: center; background: var(--bg-elevated); border: 1px solid var(--editor-border-soft); border-radius: 4px;", title: "Close", 
                        span { style: "display: block; width: 20px; height: 20px; background-color: var(--editor-text); -webkit-mask-image: {current_config.icons.panel_close}; -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center;" } 
                    }
                    div { class: "icon-preview-box", style: "aspect-ratio: 1; display: flex; align-items: center; justify-content: center; background: var(--bg-elevated); border: 1px solid var(--editor-border-soft); border-radius: 4px;", title: "Left Sidebar", 
                        span { style: "display: block; width: 20px; height: 20px; background-color: var(--editor-text); -webkit-mask-image: {current_config.icons.sidebar_left}; -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center;" } 
                    }
                    div { class: "icon-preview-box", style: "aspect-ratio: 1; display: flex; align-items: center; justify-content: center; background: var(--bg-elevated); border: 1px solid var(--editor-border-soft); border-radius: 4px;", title: "Right Sidebar", 
                        span { style: "display: block; width: 20px; height: 20px; background-color: var(--editor-text); -webkit-mask-image: {current_config.icons.sidebar_right}; -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center;" } 
                    }
                }
            }
                    ...
                    for (key, mask_uri) in current_config.icons.custom_icons.iter() {
                        div { style: "display: flex; align-items: center; justify-content: space-between; background: var(--bg-elevated); padding: 8px 12px; border: 1px solid var(--editor-border-soft); border-radius: 4px;",
                            div { style: "display: flex; align-items: center; gap: 12px;",
                                span { style: "display: block; width: 20px; height: 20px; background-color: var(--editor-text); -webkit-mask-image: {mask_uri}; -webkit-mask-size: contain; -webkit-mask-repeat: no-repeat; -webkit-mask-position: center;" }
            ...
            div { style: "display: flex; flex-direction: column; gap: 8px; background: rgba(0,0,0,0.1); padding: 12px; border-radius: 6px; border: 1px dashed var(--editor-border-soft);",
                    ...
                    button {
                        ...
                        onclick: {
                            ...
                            move |_| {
                                ...
                                if insert_custom_icon(&mut cfg, &key, &raw_svg) {
                                    apply.call(cfg);
                            ...
                            move |_| {
                                ...
                                spawn(async move {
                                    if let Some(file) = rfd::AsyncFileDialog::new().add_filter("SVG", &["svg"]).pick_file().await {
                                        ...
                                        if insert_custom_icon(&mut c, &k, &raw_svg) {
                                            a.call(c);
                                            status_msg.set("SVG added to dictionary!".to_string());
                                        } else {
                ...
                div { style: "margin-top: 8px;",
                    button {
                        ...
                        onclick: move |_| {
                            if let Err(e) = fs_bridge::open_icons_folder() {
                                status_msg.set(e);
                            }
                        },
                        "Open Local Icons Folder"
                    }
                }
            }
        }
