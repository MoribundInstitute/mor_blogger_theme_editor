...
pub fn mor_modern_editorial() -> Preset {
    ...
    // Pull the CSS file in securely at compile time (pointing to the css/ folder!)
    let modern_css = include_str!("css/mor_modern_editorial.css");

    // Attach it to the struct so it actually exports
    base.preset_css = modern_css.to_string();

    Preset {
        id: "mor_modern_editorial",
        name: "Mor Modern Editorial",
        description: "Clean hero, cards, and editorial contrast. The default.",
        base_config: base,
        preset_css: modern_css,
        dark: PresetPalette {
            colors: ColorConfig {
                bg_base: "#1a1a1f".to_string(), 
                bg_panel: SurfaceFill::solid("#23202d"),
                bg_elevated: SurfaceFill::solid("#2d2838"),
